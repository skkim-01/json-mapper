...
func (j *JsonMap) finder_search_root() interface{} {
...
func (j *JsonMap) finder_search_slice_r(sub []interface{}) interface{} {
	...
	case JsonMapType:
		...
		return j.finder_search_map_r(sub[currentKey].(map[string]interface{}))
...
func (j *JsonMap) finder_search_map_r(sub map[string]interface{}) interface{} {
	var currentKey string
	currentKey = j.splitKey[j.cursor]
