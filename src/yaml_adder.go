...
func (j *YamlObject) adder_search_root() {
...
SWITCH_TYPE:
	...
	case YamlMapType:
		...
		j.adder_search_map_r(j.m[currentKey].(map[interface{}]interface{}))
		return
...
func (j *YamlObject) adder_search_slice_r(sub []interface{}) []interface{} {
	...
	case JsonMapType:
		...
		j.adder_search_map_r(sub[currentKey].(map[interface{}]interface{}))
		return sub
...
func (j *YamlObject) adder_search_map_r(sub map[interface{}]interface{}) {
	var currentKey string
	currentKey = j.splitKey[j.cursor]
